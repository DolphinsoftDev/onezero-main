    ...
    <div className="flex flex-col px-5 py-4 md:px-[4.5rem] md:mt-[4.75rem] md:pt-0">
      ...
      <Accordion
        ...
        details={
          <>
            <p>
              מדובר במסלול בסיסי שמציע שירות בנקאות דיגיטלית עם זמינות 24/7 ללא
            ...
            <p className="text-right opacity-70 text-[11px] md:text-[14px] leading-[14px] md:leading-[18px] pt-[8px]">
        ...
        details={
          <>
            <p>
              ...
              <b>Zero</b>
              <br />
              הבסיסי שכולל פטור מעמלות עו"ש, פטור מדמי כרטיס וכולל מתן שירות 24/7,
